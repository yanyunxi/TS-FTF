        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                if args.snr_gamma is None:
                    loss = F.mse_loss(model_pred.float(), target.float(), reduction="mean") + args.style_weight * loss_style
                    ...
                    loss = F.mse_loss(model_pred.float(), target.float(), reduction="none")+ args.style_weight * loss_style
